...
<div class="flex flex-col gap-6 px-4 py-8 sm:px-10 md:px-20">
    <div class="flex flex-col gap-1">
        ...
        <h2 class="m-0 text-lg font-bold text-surface-950-50">Edit Track</h2>
    </div>
    ...
    >
        ...
        <label class="flex flex-col gap-1 text-xs font-semibold text-surface-500">
            Description
            <MarkdownEditor name="description" value={track.description} maxlength={10000} rows={10} />
        </label>
    ...
    <form method="POST" action="?/delete" class="self-start">
        <button type="submit" class="btn btn-sm preset-tonal-surface">Delete Track</button>
    </form>
</div>
