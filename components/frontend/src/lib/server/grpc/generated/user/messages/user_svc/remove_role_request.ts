...
import { GlobalRole, globalRoleFromJSON, globalRoleToJSON } from "../../entities/global_role";
...
export const RemoveRoleRequest: MessageFns<RemoveRoleRequest> = {
  ...
  fromJSON(object: any): RemoveRoleRequest {
    return {
      userId: isSet(object.userId)
        ...
        : "",
      role: isSet(object.role) ? globalRoleFromJSON(object.role) : 0,
    };
  },
  ...
  toJSON(message: RemoveRoleRequest): unknown {
    ...
    if (message.role !== 0) {
      obj.role = globalRoleToJSON(message.role);
    }
    return obj;
  },
