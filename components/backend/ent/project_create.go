...
func (_c *ProjectCreate) SetTrackID(id int) *ProjectCreate {
...
func (_c *ProjectCreate) SetHackathonID(id int) *ProjectCreate {
...
func (_c *ProjectCreate) SetCreatorID(id int) *ProjectCreate {
...
func (_c *ProjectCreate) SetModifierID(id int) *ProjectCreate {
...
func (_c *ProjectCreate) SetNillableModifierID(id *int) *ProjectCreate {
	if id != nil {
...
func (_c *ProjectCreate) AddTeamIDs(ids ...int) *ProjectCreate {
...
func (_c *ProjectCreate) AddSubmissionIDs(ids ...int) *ProjectCreate {
...
func (_c *ProjectCreate) check() error {
	...
	if len(_c.mutation.TrackIDs()) == 0 {
		return &ValidationError{Name: "track", err: errors.New(`ent: missing required edge "Project.track"`)}
	}
