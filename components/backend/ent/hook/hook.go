...
// The HackathonInviteFunc type is an adapter to allow the use of ordinary
// function as HackathonInvite mutator.
type HackathonInviteFunc func(context.Context, *ent.HackathonInviteMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f HackathonInviteFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.HackathonInviteMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.HackathonInviteMutation", m)
}

// The HackathonStateFunc type is an adapter to allow the use of ordinary
// function as HackathonState mutator.
type HackathonStateFunc func(context.Context, *ent.HackathonStateMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f HackathonStateFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.HackathonStateMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.HackathonStateMutation", m)
}
...
// The VoteCategoryFunc type is an adapter to allow the use of ordinary
// function as VoteCategory mutator.
type VoteCategoryFunc func(context.Context, *ent.VoteCategoryMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VoteCategoryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VoteCategoryMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VoteCategoryMutation", m)
}

// The VoteResultFunc type is an adapter to allow the use of ordinary
// function as VoteResult mutator.
type VoteResultFunc func(context.Context, *ent.VoteResultMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VoteResultFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VoteResultMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VoteResultMutation", m)
}
