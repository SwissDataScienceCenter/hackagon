...
func (_u *TeamUpdate) SetProjectID(id int) *TeamUpdate {
...
func (_u *TeamUpdate) AddSubmissionIDs(ids ...int) *TeamUpdate {
...
func (_u *TeamUpdate) RemoveSubmissionIDs(ids ...int) *TeamUpdate {
...
// SetProjectID sets the "project" edge to the Project entity by ID.
func (_u *TeamUpdateOne) SetProjectID(id int) *TeamUpdateOne {
	_u.mutation.SetProjectID(id)
	return _u
}
...
// AddSubmissionIDs adds the "submissions" edge to the Submission entity by IDs.
func (_u *TeamUpdateOne) AddSubmissionIDs(ids ...int) *TeamUpdateOne {
	_u.mutation.AddSubmissionIDs(ids...)
	return _u
}
...
// RemoveSubmissionIDs removes the "submissions" edge to Submission entities by IDs.
func (_u *TeamUpdateOne) RemoveSubmissionIDs(ids ...int) *TeamUpdateOne {
	_u.mutation.RemoveSubmissionIDs(ids...)
	return _u
}
