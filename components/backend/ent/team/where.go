...
func ModifiedAt(v time.Time) predicate.Team {
	return predicate.Team(sql.FieldEQ(FieldModifiedAt, v))
}
...
func ModifiedAtEQ(v time.Time) predicate.Team {
	return predicate.Team(sql.FieldEQ(FieldModifiedAt, v))
}

// ModifiedAtNEQ applies the NEQ predicate on the "modified_at" field.
func ModifiedAtNEQ(v time.Time) predicate.Team {
	return predicate.Team(sql.FieldNEQ(FieldModifiedAt, v))
}

// ModifiedAtIn applies the In predicate on the "modified_at" field.
func ModifiedAtIn(vs ...time.Time) predicate.Team {
	return predicate.Team(sql.FieldIn(FieldModifiedAt, vs...))
}

// ModifiedAtNotIn applies the NotIn predicate on the "modified_at" field.
func ModifiedAtNotIn(vs ...time.Time) predicate.Team {
	return predicate.Team(sql.FieldNotIn(FieldModifiedAt, vs...))
}

// ModifiedAtGT applies the GT predicate on the "modified_at" field.
func ModifiedAtGT(v time.Time) predicate.Team {
	return predicate.Team(sql.FieldGT(FieldModifiedAt, v))
}

// ModifiedAtGTE applies the GTE predicate on the "modified_at" field.
func ModifiedAtGTE(v time.Time) predicate.Team {
	return predicate.Team(sql.FieldGTE(FieldModifiedAt, v))
}

// ModifiedAtLT applies the LT predicate on the "modified_at" field.
func ModifiedAtLT(v time.Time) predicate.Team {
	return predicate.Team(sql.FieldLT(FieldModifiedAt, v))
}

// ModifiedAtLTE applies the LTE predicate on the "modified_at" field.
func ModifiedAtLTE(v time.Time) predicate.Team {
	return predicate.Team(sql.FieldLTE(FieldModifiedAt, v))
}
...
func HasModifier() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasModifierWith(preds ...predicate.User) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func HasSubmissions() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSubmissionsWith(preds ...predicate.Submission) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
// HasTeamParticipants applies the HasEdge predicate on the "team_participants" edge.
func HasTeamParticipants() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasTeamParticipantsWith applies the HasEdge predicate on the "team_participants" edge with a given conditions (other predicates).
func HasTeamParticipantsWith(preds ...predicate.TeamParticipant) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := newTeamParticipantsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
