...
Join table for the M2M relationship between users and hackathons, with
...
- `version, project_submissions, team_submissions` _(unique)_
...
- `name, hackathon_tracks` _(unique)_
