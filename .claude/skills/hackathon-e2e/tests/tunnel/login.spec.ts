...
/**
 * Proves OIDC login works through the Cloudflare quick tunnel. Bring the
 * tunnel up with issuer rewiring first, then run with its URL:
 *
 ...
 * means the issuer rewiring is not in effect (view-only tunnel).
 */
